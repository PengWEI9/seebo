...
//TBIRD-STAN 1.3.5 MODS - START
//TBIRD 1.3.4 MODS - START
/*bool CGUIWindowPVRRecordings::OnContextButtonUser1(CFileItem *item, CONTEXT_BUTTON button)
{
  bool bReturn = false;
...
bool CGUIWindowPVRRecordings::OnContextButtonUser2(CFileItem *item, CONTEXT_BUTTON button)
{
  bool bReturn = false;
...
bool CGUIWindowPVRRecordings::OnContextButtonUser3(CFileItem *item, CONTEXT_BUTTON button)
{
  bool bReturn = false;
...
bool CGUIWindowPVRRecordings::OnContextButtonUser4(CFileItem *item, CONTEXT_BUTTON button)
{
  bool bReturn = false;
...
bool CGUIWindowPVRRecordings::OnContextButtonUser5(CFileItem *item, CONTEXT_BUTTON button)
{
  bool bReturn = false;
