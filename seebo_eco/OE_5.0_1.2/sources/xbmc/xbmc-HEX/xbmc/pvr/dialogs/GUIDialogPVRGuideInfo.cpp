...
//(+)TBIRD - ECOh 1.2.1 - START
#include "pvr/addons/PVRClients.h"
//(+)TBIRD - ECOh 1.2.1 - FINISH 
...
//////////////////BADJIN : 08/03/2016 //////////////
      ;
      //CStdString msg = StringUtils::Format(g_localizeStrings.Get(19035).c_str(), g_localizeStrings.Get(19029).c_str()); 
      // Channel could not be played. Check the log for details.
...
void CGUIDialogPVRGuideInfo::OnInitWindow()
{
  ...
  g_PVRClients->GetClientName(tag->ChannelTag()->ClientID(), clientName);
