...
public:
  ...
  //peng
  bool isMultiplexOccupied(int clientChannelUid, int state, int clientIndex, int startTime);
  bool isMultiplexOccupied_(int clientChannelUid, int state, int clientIndex, int startTime);
