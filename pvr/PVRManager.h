...
namespace PVR
{
  ...
  public:
     ...
     */
    void ResetDatabase(bool bResetEPGOnly = false, bool showProgBar = true );
    //(+)TBIRD - ECO - START
    void SilentDatabaseReset(bool bResetEPGOnly = false);
    //(+)TBIRD - ECO - FINISH
    ...
    //peng////////////////
    static std::map <int,int> m_recordingMap; 
  public: 
