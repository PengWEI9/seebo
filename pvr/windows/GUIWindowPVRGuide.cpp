...
//TBIRD-STAN 1.3.5 MODS - START
//TBIRD 1.3.4 MODS - START
/*bool CGUIWindowPVRGuide::OnContextButtonUser1(CFileItem *item, CONTEXT_BUTTON button)
{
  bool bReturn = false;
...
bool CGUIWindowPVRGuide::OnContextButtonUser2(CFileItem *item, CONTEXT_BUTTON button)
{
  bool bReturn = false;
...
bool CGUIWindowPVRGuide::OnContextButtonUser3(CFileItem *item, CONTEXT_BUTTON button)
{
  bool bReturn = false;
...
bool CGUIWindowPVRGuide::OnContextButtonUser4(CFileItem *item, CONTEXT_BUTTON button)
{
  bool bReturn = false;
...
bool CGUIWindowPVRGuide::OnContextButtonUser5(CFileItem *item, CONTEXT_BUTTON button)
{
  bool bReturn = false;
