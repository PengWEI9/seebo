...
namespace PVR
{
  ...
  protected:
	...
	virtual bool StartRecordFileInAll(CFileItem *item);
	virtual bool StopRecordFileInAll(CFileItem *item);
    ...
    bool OnContextButtonPVRChannels(CONTEXT_BUTTON button);
    bool OnContextButtonPVRGuide(CONTEXT_BUTTON button);
    bool OnContextButtonPVRRecording(CONTEXT_BUTTON button);
    bool OnContextButtonPVRTimers(CONTEXT_BUTTON button);
    bool OnContextButtonPVRSearch(CONTEXT_BUTTON button);
    ...
    //TBIRD 1.3.5 MODS - FINISH
    bool OnContextButtonDeleteAllRec(CFileItem *item, CONTEXT_BUTTON button); 
    //TBIRD 1.3.6 MODS - START
    bool OnContextButtonAddLock(CFileItem *item, CONTEXT_BUTTON button);
    bool OnContextButtonRemoveLock(CFileItem *item, CONTEXT_BUTTON button);
    //TBIRD 1.3.6 MODS - FINISH
    //TUAN's MODS 1.3.6 START
    void ActionDeleteAllRecordings(CFileItem *item);
    bool ActionDeleteRecordingInAll(CFileItem *item);
