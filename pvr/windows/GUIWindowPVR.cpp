...
{
  CreateViews();
  //Sameera 05-10-2015 - LiveTV views crash bug
  m_bWasReset = true;
  //Sameera 05-10-2015 - LiveTV views crash bug
...
void CGUIWindowPVR::PerformButtonAction(CONTEXT_BUTTON button)
{
	m_currentSubwindow->OnContextButton(m_viewControl.GetSelectedItem(), button);
}
